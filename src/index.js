  ...
  render: function (subject, dataBrowserContext) {
    ...
    */
    ...
    const selectNewTool = function (_event) {
      visible = !visible
      star.classList.toggle('meetingToolIcon-yellow', visible)
    ...
    const resetTools = function () {
      ...
      star.classList.remove('meetingToolIcon-yellow')
    }
    ...
    const selectTool = function (icon) {
      ...
      toggleIconsVisibility(false)
      for (let i = 0; i < iconArray.length; i++) {
        iconArray[i].classList.remove('meetingToolIcon-yellow')
      }
      icon.classList.add('meetingToolIcon-visible', 'meetingToolIcon-yellow')
      star.classList.remove('meetingToolIcon-yellow')
    }
